...
SHELL := /bin/bash
SCRIPTS := scripts/deploy.sh scripts/validate.sh scripts/restore.sh scripts/uninstall.sh scripts/update.sh scripts/install-cores.sh scripts/add-to-steam.sh scripts/smoke-fedora-container.sh
